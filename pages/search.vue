    ...
    <div>
        ...
        <form class="max-w-md mx-auto">   
            ...
            <div class="relative">
                ...
                <input v-model="searchTerm" type="text" id="default-search" class="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search for Movies and TvSeries" required />
            </div>
        </form>

        <section>
            <h1 v-if="movies.length" class="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-black">Movies Resaults</h1>
        ...
        <section>
            <h1 v-if="series.length" class="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-black">Tv Series Resaults</h1>
